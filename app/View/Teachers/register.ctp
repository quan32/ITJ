<div>
	<?php
		...
		<span id='website_rule'>
			e-Learning ウェブサイトメンバーにご登録いただいた個人情報は、ご本人からのお問合せに対する回答や、電子メール、ダイレクトメールなどによるフォーラム関連情報やeラーニングに関する情報提供時に利用するほか、受講をご予約頂いた講演の演者及びスポンサーに提供されます。ご本人ウェブサイトの承諾なしに上記内容の目的以外に利用することはありません。 また、当ウェブサイトの委託業者が、利用目的の範囲内で情報を使用することがございます。
		</span>
		<?php
